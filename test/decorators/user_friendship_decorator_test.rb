...
class UserFriendshipDecoratorTest < Draper::TestCase
  context "#sub_message" do
    setup do
      @friend = create(:user, first_name: "Joseph")
    end
    ...
    context "with a pending user friendship" do
      ...
      should "return the correct message" do
        assert_equal "Do you realy want to be friends with Joseph?", @decorator.sub_message
      end
    end
    ...
    context "with an accepted user friendship" do
      ...
      should "return the correct message" do
        assert_equal "You are friends with Joseph.", @decorator.sub_message
      end
    end
  end
